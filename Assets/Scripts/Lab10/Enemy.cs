...
public class EnemyLab10 : MonoBehaviour
{
	...
	public int damagePerProjectile = 2;
	...
	void Start()
	{
		...
		{
			maxHealth *= GameStateLab10.Instance.EnemyHpMultiplier();
		}
		health = maxHealth;
	...
	void Shoot(Vector3 dir)
	{
		...
		if (Physics.Raycast(origin, dir, out RaycastHit hit, shootRange, ~0, QueryTriggerInteraction.Ignore))
		{
			...
			PlayerLab10 p = hit.collider.GetComponentInParent<PlayerLab10>();
			if (p != null)
			{
